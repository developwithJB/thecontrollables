  ...
  public: {
    Tables: {
      ...
      dated_goal_daily_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "dated_goal_daily_logs_goal_id_fkey"
            columns: ["goal_id"]
            isOneToOne: false
            referencedRelation: "dated_goals"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      cancel_fully_charged_attempt: {
        ...
        Returns: Database["public"]["Tables"]["formation_attempts"]["Row"]
      }
      ...
      start_fully_charged_attempt: {
        Args: {
          ...
          p_previous_attempt_id?: string | null
