...
export const RING_DEFINITIONS: RingDefinition[] = [
  {
    ...
    emoji: "🦉",
    meaning: "Pause and become aware of your thoughts, feelings, energy, or current state.",
    prompt: "What are you noticing about yourself right now?",
    color: "awareness",
  },
  {
    key: "choose",
    ...
    emoji: "🐢",
    meaning: "Choose a better frame, response, or mindset for the day.",
    prompt: "What's one thing you can choose to see differently today?",
    color: "perspective",
  },
  {
    key: "prove",
    ...
    controllable: "habit",
    emoji: "🦈",
    meaning: "Prove who you are through action by completing your key daily promise.",
    prompt: "What's the one action that proves who you're becoming?",
    color: "habit",
  },
  {
    key: "charge",
    ...
    emoji: "🛰️",
    meaning: "Build energy through movement, recovery, hydration, nutrition, or sleep.",
    prompt: "What did you do to recharge today?",
    color: "wellness",
  },
  {
    key: "align",
    ...
    emoji: "🚀",
    meaning: "Align your surroundings, inputs, and relationships with who you want to become.",
    prompt: "What's one thing you aligned in your surroundings today?",
    color: "environment",
  },
];
