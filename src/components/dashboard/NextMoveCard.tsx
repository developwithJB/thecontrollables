...
export function NextMoveCard({ health, calendarIntel, wearableConnected }: NextMoveCardProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Next best move</span>
      </div>
