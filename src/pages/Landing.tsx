...
const happyPathSteps = [
  {
    step: "01",
    title: "Find Your Starting Charge",
    copy: "See what is leading, what needs charge, and where Ego gets loud.",
    icon: Gauge,
  },
  {
    step: "02",
    title: "Choose Your Journey",
    copy: "Pick Reset, Charge, or Upgrade. Then choose your Starter Controllable.",
    icon: Compass,
  },
  {
    step: "03",
    title: "Complete Mission 001",
    copy: "Every morning, missions drop. Complete one real-life rep and earn XP.",
    icon: Target,
  },
  {
    step: "04",
    title: "Build Your Dex",
    copy: "Optionally add photo proof and collect private evidence of who you are becoming.",
    icon: Camera,
  },
];
        ...
        <section className="px-5 pb-16 pt-10 md:px-8 md:pb-24 md:pt-16">
          <div className="mx-auto max-w-5xl text-center">
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-muted-foreground text-balance md:text-xl">
                Find your Starting Charge, get Mission 001, and start charging your Controllables one day at a time.
              </p>
              <div className="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row">
                ...
                >
                  <Button variant="glow" size="lg" className="h-14 w-full px-10 text-base font-semibold sm:w-auto">
                    Start Your Scan
                ...
                >
                  <Button variant="outline" size="lg" className="h-14 w-full px-8 text-base font-semibold sm:w-auto">
                    See How It Works
                  </Button>
                </a>
              </div>
              <div className="mt-6 flex flex-wrap items-center justify-center gap-2 text-xs text-muted-foreground">
                {["Starting Charge", "Mission Drop", "Self-Trust", "Controllables Dex"].map((chip) => (
        ...
        <section id="how-it-works" className="scroll-mt-8 px-5 py-16 md:px-8 md:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="mb-10 flex flex-col gap-2 text-center">
              <p className="text-xs font-semibold uppercase text-primary">What happens next</p>
              <h2 className="font-display text-3xl font-semibold text-foreground">From scan to proof</h2>
            </div>
            <div className="grid gap-3 md:grid-cols-4">
              {happyPathSteps.map((item, index) => {
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {journeyEditions.map((edition) => (
                <div key={edition.title} className="rounded-lg border bg-card p-5">
                  ...
                  <p className="mt-5 text-sm text-muted-foreground">{edition.bestFor}</p>
        ...
        <section className="border-t border-border/40 px-5 py-16 md:px-8 md:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="mb-10 text-center">
              ...
              <p className="mt-3 text-sm text-muted-foreground">Choose your Starter Controllable. Then start Mission 001.</p>
            </div>
